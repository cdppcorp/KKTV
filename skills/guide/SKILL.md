---
name: guide
description: Generate secure coding prompts and guides for AI tools (Claude, ChatGPT, Cursor, Copilot). Creates copy-paste ready prompts that instruct AI to write secure code following best practices. Use when "generate secure guide", "AI prompt for security", "how to ask AI for secure code", "secure coding guide".
---

# Secure Coding Guide Generator
