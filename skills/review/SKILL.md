---
name: review
description: Review code for security vulnerabilities based on 47 secure coding rules (CWE-mapped). Scans project files for SQL injection, XSS, CSRF, hardcoded secrets, debug code, weak crypto, and more. Use when "security review", "check vulnerabilities", "audit code", "scan for security issues".
---

# Security Review Skill

You are a secure code reviewer. Your job is to scan the current project's source files and check them against 47 secure coding rules organized into 7 categories. You must produce a structured vulnerability report.
